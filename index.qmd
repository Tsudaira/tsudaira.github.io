...
```{=html}
<iframe height="100%" width="100%" frameborder="no" src="https://tsudaira.shinyapps.io/final_project/"> </iframe>
```
Today, unicorns can be found globally, a stark contrast to a decade or two ago where the majority of them were founded in the United States. Looking at the number of startups by country, it is clear that the United States, China, and India take the lead on volume of startups founded. This indicates a supportive startup ecosystem in such countries, where the bulk of startups are headquartered in cities such as California, Shanghai, and Bengaluru. There is no question in operating in one of these 'Silicon Valleys', where innovation and funding are much easier to come by. However, although these are certainly popular, such cities are not the only regions where startups can find success.

What is more intrguing and possibly more important, is the rate of emergence of unicorns in countries such as China, South Korea, and Israel. Combined, the startups founded in the 3 countries are only a fraction of the number located in the United States, but boast much higher success rates of unicorns, with China sporting an unbelievable 1 in 4 unicorns.
...
Enterprise Technologies leads the pack with 30.3% of unicorns under the sector, followed closely by Finance, Retail, and Industrials at 17.7, 17.6, and 15.6% share respectively. Valuation wise, the data shows that the proportion of companies more or less equal the valuation of each sector. The one outlier being in Media with a 6.63% share of companies, but taking a 13% share in valuation. This is the result of ByteDance, the highest valued unicorn in the world, coming in at USD\$225 Billion.

Although there is no definitive answer to which is the correct industry choice for your startup to make money, this donut chart may give further insights to which sectors are more reliable, or perhaps even identify which sectors may have a gap in the market.
